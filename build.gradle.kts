...
mavenPublishing {
    ...
    pom {
        ...
        url = "https://github.com/vibenilla/crafting"
        ...
        scm {
            url = "https://github.com/vibenilla/crafting"
            connection = "scm:git:git://github.com/vibenilla/crafting.git"
            developerConnection = "scm:git:ssh://git@github.com/vibenilla/crafting.git"
        }
    }
}
